...
### read data ---------------
weights_data.raw<-read.csv("PAA/assets_weights.csv") ## read in weights data 
weights_data<-xts(weights_data.raw[,-1],ymd(weights_data.raw[,1])) ## convert to xts

returns_data.raw<-read.csv("PAA/assets_returns.csv") ## read in price data 
...
#### generate PAA portfolio with 14 assets
```{r}
