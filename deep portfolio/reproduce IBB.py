...
# visualize best/worst communal
#which_stock = ranking_table.iloc[0,0]
#which_stock = ranking_table.iloc[(len(ranking_table.iloc[:,0])-1),0]
which_stock = 2
...
relative_percentage_25 = pd.DataFrame(relative_percentage_test['calibrate'][25])
relative_percentage_45 = pd.DataFrame(relative_percentage_test['calibrate'][45])
relative_percentage_65 = pd.DataFrame(relative_percentage_test['calibrate'][65])
...
relative_percentage_table.columns = [15,35,55, 'original']
...
for non_communal in [15, 35, 55]:  
 ...
 # construct a percentage change table    
relative_percentage_25 = pd.DataFrame(relative_percentage_test['validate'][25])
relative_percentage_45 = pd.DataFrame(relative_percentage_test['validate'][45])
relative_percentage_65 = pd.DataFrame(relative_percentage_test['validate'][65])
