...
##### risk assets: SPY, SCZ
##### defensive assets: TLT. TIP
##### Benchmark: 60/40 benchmark with SPY and TLT

## Process
##### downloaded data from yahoo Finance.
```{r echo=FALSE}
weights_data.raw<-read.csv("C:\\Users\\carol\\Desktop\\asset_allocation\\ADM\\assets_weights.csv") ## read in weights data 
weights_data<-xts(weights_data.raw[,-1],ymd(weights_data.raw[,1])) ## convert to xts

returns_data.raw<-read.csv("C:\\Users\\carol\\Desktop\\asset_allocation\\ADM\\assets_returns.csv") ## read in returns data 
