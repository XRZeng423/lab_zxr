...
i <- 1
ratio <- 0.2
trading_months <- as.Date("2005-01-01")+months(seq(0,146,3))
...
write.csv(seaport,file ="results\\value\\PTA-portfolio.csv",)
write.csv(results_des,file ="results\\value\\PTA-result.csv",)