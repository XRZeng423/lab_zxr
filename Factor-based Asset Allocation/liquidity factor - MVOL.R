...
for (i in 1:nmonth){
  ...
  x <- trading_data$Msmvosd[trading_data$Trdmnt == trading_lastmonth]
...
write.csv(seaport,file ="results\\liquidity\\size_MVOL-portfolio.csv",)
write.csv(results_des,file ="results\\liquidity\\size_MVOL-result.csv",)
