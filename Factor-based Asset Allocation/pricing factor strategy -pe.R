...
for (i in 1:nseason){
  x <- pricing_factor_data$F100101B [pricing_factor_data$Accper == trading_months[i]]
...
write.csv(seaport,file ="results\\value\\PE-portfolio.csv",)
write.csv(results_des,file ="results\\value\\PE-result.csv",)