...
#trading_months <- as.Date("2005-04-01")+months(seq(0,145,3))    ##2017-01-01
...
write.csv(seaport,file ="results\\value\\PB-portfolio.csv",)
write.csv(results_des,file ="results\\value\\PB-result.csv",)
