...
##### Offensive assets: SPY, EFA, EEM, AGG
##### defensive assets: LQD, IEF, SHY
...
```{r echo=FALSE}
weights_data.raw<-read.csv("C:\\Users\\carol\\Desktop\\asset_allocation\\VAA\\assets_weights.csv") ## read in weights data 
weights_data<-xts(weights_data.raw[,-1],ymd(weights_data.raw[,1])) ## convert to xts

returns_data.raw<-read.csv("C:\\Users\\carol\\Desktop\\asset_allocation\\VAA\\assets_returns.csv") ## read in returns data 
